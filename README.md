...
* [x] Implement support of Reverse-proxy via environment variable with CSRF support
...
* **SMART_FOLDERS_ENABLED**: enable [Smart Folders](https://docs.alfresco.com/5.2/concepts/sf-config-workflow.html) `false`
